  ...
  return (
    <div className="min-h-screen bg-dark-950">
      <div className="max-w-3xl mx-auto px-4 lg:px-8 py-8">
        <Link
          href="/forum"
          className="inline-flex items-center gap-2 text-content-3 hover:text-content-1 transition-colors mb-6"
        >
          <ArrowLeft className="w-4 h-4" />
          Volver al foro
        </Link>

        <h1 className="text-3xl font-bold text-content-1 mb-8">Crear nuevo tema</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full h-12 px-4 bg-dark-2 border border-dark-5 rounded-xl text-content-1 placeholder:text-content-3 focus:outline-none focus:border-accent-500/50 transition-colors"
              required
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full h-12 px-4 bg-dark-2 border border-dark-5 rounded-xl text-content-1 focus:outline-none focus:border-accent-500/50 transition-colors"
              required
            >
          ...
          <div>
            ...
            <div className="bg-dark-2 border border-dark-5 rounded-xl overflow-hidden">
              <ForumEditor
                value={content}
                onChange={setContent}
          ...
          <div className="flex gap-4 pt-4">
            <Link
              href="/forum"
              className="px-6 py-3 bg-dark-3 hover:bg-dark-4 text-content-1 font-medium rounded-xl transition-colors"
            >
              Cancelar
            </Link>
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-accent-500 hover:bg-accent-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold rounded-xl transition-colors"
            >
